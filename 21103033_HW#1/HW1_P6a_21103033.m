...
n_disp(i_fdof,1)=(k_global(i_fdof,i_fdof))\(F_global(i_fdof,1)-(k_global(i_fdof,i_edof)*n_disp(i_edof,1)));
...
for e=1:num_elem
    ...
    if(n2==hinge(e+1))
        ...
        k_elem=[ a       0       0       -a       0;
                ...
                -a       0       0        a       0;
                 0     -3*b   -3*b*l      0      3*b;];
        u_elem(1:5,1)=T*u(1:5,1); %converting back to element co-ord. system
        %unknown nodal rotation
        u(6,1)=u(6,1) - ([0 6*b*l 2*b*(l^2) 0 -6*b*l]*u(1:5,1))/(4*b*(l^2));
